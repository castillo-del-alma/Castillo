...
insert into public.gay_content (key, value) values
  ...
  ('hero_meta', '[{"da": ["To retreats om året"], "en": ["Two retreats a year"]}, {"da": ["Seksten mænd"], "en": ["Sixteen men"]}, {"da": ["Syv dage"], "en": ["Seven days"]}]'),
  ...
  ('uge_items', '[{"da": ["Saunaritualer", "Guidede aufguss-sessioner med æteriske olier og koldt vand bagefter — det tætteste ugen kommer på en fast ceremoni."], "en": ["Sauna rituals", "Guided aufguss sessions with essential oils and cold water afterwards — the closest thing the week has to a fixed ceremony."]}, {"da": ["Breathwork", "Sessioner der flytter overraskende meget for noget, der handler om at ligge stille. Begyndere er velkomne; der er ingen forkert måde."], "en": ["Breathwork", "Sessions that move a surprising amount for something that involves lying still. Beginners welcome; there is no wrong way to do it."]}, {"da": ["Kakaoceremoni", "En aftencirkel omkring ceremoniel kakao, hvor pointen er mindre drikken end det, der bliver sagt omkring den."], "en": ["Cacao ceremony", "An evening circle built around ceremonial cacao, where the point is less the drink than what gets said around it."]}, {"da": ["Tantra", "Grebet an som nærvær og forbindelse frem for præstation. Altid med samtykke, altid noget man kan sidde over."], "en": ["Tantra", "Approached as presence and connection rather than performance. Always consent-led, always something you can sit out."]}, {"da": ["Bordet", "Lange middage med andalusisk mad og vin fra ejendommens egen mark. Det er her, det meste af ugen faktisk sker."], "en": ["The table", "Long dinners with Andalusian food and wine from the estate''s own vineyard. This is where most of the week actually happens."]}, {"da": ["Ingenting", "Poolen, en bog, stien gennem vinmarken, en middagslur på to timer. Den ustrukturerede tid er en del af programmet, ikke et hul i det."], "en": ["Nothing at all", "The pool, a book, the vineyard path, a two-hour nap. Unstructured time is part of the programme, not a gap in it."]}]'),
  ...
  ('sted_afstande', '[{"da": ["45 min", "Málaga lufthavn"], "en": ["45 min", "Málaga airport"]}, {"da": ["75 min", "Granada"], "en": ["75 min", "Granada"]}, {"da": ["90 min", "Sevilla"], "en": ["90 min", "Seville"]}]'),
  ...
  ('faq_items', '[{"da": ["Hvem er disse retreats for?", "Bøsser, og kun bøsser — det er hele pointen med at lukke ejendommen frem for at køre et blandet program. Mænd kommer alene, som par og som venner. Aldrene spænder vidt, og ingen er til overs."], "en": ["Who are these retreats for?", "Gay men, and only gay men — that is the point of closing the estate rather than running a mixed programme. Men come on their own, as couples and as friends. Ages vary widely and no one is the odd one out."]}, {"da": ["Kan jeg komme alene?", "Det gør de fleste. En lukket gruppe på seksten i en hel uge betyder, at du ikke kommer til at være fremmed ugen igennem — ved anden middag holder det op med at føles som en samling enkeltpersoner."], "en": ["Can I come alone?", "Most men do. A closed group of sixteen for a full week means you will not spend the week as a stranger — by the second dinner it stops feeling like a group of individuals."]}, {"da": ["Skal jeg have erfaring med breathwork, tantra eller meditation?", "Nej. Sessionerne ledes med førstegangsdeltagere for øje, og alt er frivilligt. At sidde en over er helt normalt, ikke en udmelding."], "en": ["Do I need experience with breathwork, tantra or meditation?", "No. Sessions are led with first-timers in mind and everything is optional. Sitting one out is a normal thing to do, not a statement."]}, {"da": ["Hvor foregår det præcis?", "På Castillo del Alma, en privat vinejendom uden for Mollina i Málaga-provinsen, Andalusien. Hele ejendommen er reserveret til gruppen — der er ingen andre gæster."], "en": ["Where exactly is the retreat held?", "At Castillo del Alma, a private wine estate outside Mollina in the province of Málaga, Andalusia. The whole estate is reserved for the group — there are no other guests."]}, {"da": ["Hvordan kommer jeg dertil fra Málaga lufthavn?", "Turen tager cirka femogfyrre minutter. Lejebil er ligetil, og vi kan hjælpe med at arrangere transport, hvis du hellere vil hentes. Send os dine flytider, når du booker."], "en": ["How do I get there from Málaga airport?", "The drive is roughly forty-five minutes. Hire cars are straightforward, and we can help arrange a transfer if you would rather be picked up. Let us know your flight times when you book."]}, {"da": ["Hvad er inkluderet i prisen?", "Ophold, måltider, vin til middagen, brug af pool og wellness samt hele programmet. På hvert retreats egen side står præcis, hvad der er med, sammen med eventuelle tilvalg som massage."], "en": ["What is included in the price?", "Accommodation, meals, wine at dinner, use of the pool and wellness facilities and the full programme of sessions. Each retreat page lists exactly what is covered, along with any optional extras such as massage."]}, {"da": ["Hvor mange deltager?", "Ejendommen har plads til seksten, og det er loftet. Det er lille nok til, at alle rent faktisk kender hinanden, når ugen er omme."], "en": ["How many men attend?", "The estate sleeps sixteen, and that is the ceiling. It is small enough that everyone actually knows everyone by the end of the week."]}, {"da": ["Hvilket sprog tales der?", "Retreats afholdes på engelsk og dansk. Gæsterne kommer fra hele Europa, og gruppens arbejdssprog finder sig selv i løbet af en dag."], "en": ["What language is spoken?", "Retreats are run in English and Danish. Guests come from across Europe, and the working language of the group settles itself within a day."]}]'),
