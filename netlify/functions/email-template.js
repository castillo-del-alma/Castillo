const texts = {
  da: {
    ...
    reservation_intro: 'Vi har modtaget din reservation og er glade for at byde dig velkommen til Castillo del Alma. For at sikre din plads på det valgte retreat skal depositum indbetales inden for 24 timer.',
    ...
    payment_subject: 'Din plads er reserveret — betal depositum inden 24 timer',
    ...
    payment_deadline: 'Betalingsfrist: 24 timer',
  ...
  en: {
    ...
    reservation_intro: 'We have received your reservation and are delighted to welcome you to Castillo del Alma. To secure your place on the selected retreat, please pay the deposit within 24 hours.',
    ...
    payment_subject: 'Your place is reserved — pay deposit within 24 hours',
    ...
    payment_deadline: 'Payment deadline: 24 hours',
