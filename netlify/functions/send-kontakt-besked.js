...
exports.handler = async (event) => {
  ...
  const K = ktLang === 'da' ? {
    ...
    intro: `Kære ${navn},\n\nTak for din henvendelse til Castillo del Alma. Vi har modtaget din besked og vender tilbage inden for 24 timer.`,
    ...
    intro: `Dear ${navn},\n\nThank you for contacting Castillo del Alma. We have received your message and will get back to you within 24 hours.`,
